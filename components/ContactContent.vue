    ...
    <section class="contact-section" aria-labelledby="contact-heading">
      <div class="contact-section__wrapper">
        ...
        <div class="contact-section__form-area">
          <h2 id="contact-heading" class="contact-section__heading">Kapcsolat</h2>
          <p class="contact-section__description">
            Kérdése van, árajánlatot szeretne, vagy csak érdeklődne? Írjon nekünk e-mailt vagy hívjon telefonon – gyorsan és készséggel válaszolunk minden megkeresésre!
          </p>
          <form
          ...
          >
            <div class="contact-section__fields">
              ...
              <div class="contact-section__field-group">
                <label class="contact-section__label" for="phone">Telefonszám*</label>
                <input
                  class="contact-section__input"
                  type="tel"
                  id="phone"
              ...
              <div class="contact-section__field-group">
                <label class="contact-section__label" for="email">E-mail cím*</label>
                <input
                  class="contact-section__input"
                  type="email"
                  id="email"
            ...
            <div class="contact-section__actions">
              <button type="submit" class="contact-section__submit">KÜLDÉS</button>
              <p class="contact-section__note">
                A küldés gombra kattintva automatikusan elfogadja az <a href="/privacy-policy" class="contact-section__policy-link">Adatkezelési Nyilatkozatot</a>.
              </p>
            </div>
          </form>
        </div>
        ...
        <!-- Contact Info -->
        <aside class="contact-section__info-area" aria-labelledby="info-heading">
          <h2 id="info-heading" class="contact-section__heading">Elérhetőségeink</h2>
          <address class="contact-section__info-list">
            <div class="contact-section__info-item">
              <span class="contact-section__info-icon" aria-hidden="true">📍</span>
              <span class="contact-section__info-label">Cím</span>
              <span class="contact-section__info-text">2000 Szentendre, Rózsa utca 14.</span>
            </div>
            <div class="contact-section__info-item">
              <span class="contact-section__info-icon" aria-hidden="true">✉️</span>
              <span class="contact-section__info-label">E-mail cím</span>
              <a
                href="mailto:bola95kft@t-online.hu"
                class="contact-section__info-text"
              >
                bola95kft@t-online.hu
              </a>
            </div>
            <div class="contact-section__info-item">
              <span class="contact-section__info-icon" aria-hidden="true">📞</span>
