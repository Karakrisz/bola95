...
declare module "nitropack/types" {
  ...
  interface InternalApi {
    '/api/beton_service_sitemap': {
      'default': Simplify<Serialize<Awaited<ReturnType<typeof import('../../server/api/beton_service_sitemap').default>>>>
    }
    '/api/beton_service': {
      'default': Simplify<Serialize<Awaited<ReturnType<typeof import('../../server/api/beton_service').default>>>>
    }
    '/__nuxt_error': {
